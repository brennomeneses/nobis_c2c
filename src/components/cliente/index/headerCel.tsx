  ...
  return (
    <>
      <div className='header' style={{ backgroundColor: "#D2BFF6", paddingBottom: "1%" }}>
        ...
        <a className='btnTroca' style={{ cursor: "pointer", color: "#4C3779", border: "1px solid #4C3779", backgroundColor: "#D2BFF6", marginLeft: "5%", marginRight: "5%" }} onClick={handlePrestadorClick}>
          <Space style={{ fontSize: "10px" }}>
            QUERO PRESTAR SERVIÇOS
          </Space>
        </a>
        <a className='btnTroca' style={{ cursor: "pointer", color: "#4C3779", border: "1px solid #4C3779", backgroundColor: "white", marginRight: "5%" }}>
          <Space style={{ fontSize: "10px" }}>
